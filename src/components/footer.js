const vivirionMark = new URL("../../Assets/Group 54.svg", import.meta.url).href;
  ...
  return `
    <footer class="footer reveal reveal-delay-2">
      ...
      <div class="social-links">
        ...
        <a class="social-logo-link" href="https://vivirion.com" target="_blank" rel="noreferrer" aria-label="Vivirion website">
          <img src="${vivirionMark}" alt="Vivirion" />
        </a>
      </div>
    </footer>
  `;
