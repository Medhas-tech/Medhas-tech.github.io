  ...
  palettes: [
    {
      ...
      values: {
        ...
        "--bg-gradient-end": "#f3ede2",
        "--blob-a": "rgba(185, 133, 160, 0.11)",
        "--blob-b": "rgba(110, 167, 166, 0.1)",
        "--grid-line": "rgba(61, 51, 67, 0.025)",
        "--surface-primary": "rgba(255, 255, 255, 0.9)",
        "--surface-secondary": "rgba(237, 231, 221, 0.82)",
        "--surface-featured-a": "rgba(251, 249, 253, 0.92)",
        "--surface-featured-b": "rgba(235, 229, 241, 0.84)",
        "--surface-contact-a": "rgba(245, 249, 248, 0.92)",
        "--surface-contact-b": "rgba(232, 237, 229, 0.84)",
      },
    },
    {
      id: "mint-noir",
      name: "Emerald Study",
      accent: "Emerald + ivory",
      values: {
        "--bg": "#f2f4ee",
        "--ink": "#1f1f27",
        "--paper": "#fafcf8",
        ...
        "--lime": "#c9c6a3",
        "--pink": "#a6858f",
        "--bg-gradient-start": "#f4f7f0",
        "--bg-gradient-end": "#e8ece1",
        "--blob-a": "rgba(166, 133, 143, 0.1)",
        "--blob-b": "rgba(95, 142, 131, 0.11)",
        "--grid-line": "rgba(66, 73, 67, 0.025)",
        "--surface-primary": "rgba(251, 253, 249, 0.92)",
        "--surface-secondary": "rgba(231, 236, 226, 0.85)",
        "--surface-featured-a": "rgba(245, 250, 247, 0.92)",
        "--surface-featured-b": "rgba(228, 235, 228, 0.84)",
        "--surface-contact-a": "rgba(244, 249, 244, 0.92)",
        "--surface-contact-b": "rgba(227, 234, 224, 0.84)",
      },
    },
    {
      id: "blue-zest",
      name: "Midnight Drawing Room",
      accent: "Ink blue + rose",
      values: {
        "--bg": "#f1f3f8",
        "--ink": "#1d2131",
        "--paper": "#f8f9fd",
        ...
        "--lime": "#bcb89f",
        "--pink": "#9d87a6",
        "--bg-gradient-start": "#f3f5fb",
        "--bg-gradient-end": "#e7eaf3",
        "--blob-a": "rgba(157, 135, 166, 0.11)",
        "--blob-b": "rgba(111, 142, 169, 0.11)",
        "--grid-line": "rgba(54, 63, 84, 0.025)",
        "--surface-primary": "rgba(249, 251, 255, 0.92)",
        "--surface-secondary": "rgba(232, 236, 245, 0.84)",
        "--surface-featured-a": "rgba(245, 246, 253, 0.92)",
        "--surface-featured-b": "rgba(229, 231, 243, 0.84)",
        "--surface-contact-a": "rgba(242, 247, 252, 0.92)",
        "--surface-contact-b": "rgba(227, 233, 243, 0.84)",
      },
    },
  ],
};
